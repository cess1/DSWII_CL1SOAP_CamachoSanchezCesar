package pe.edu.cibertec.DSWII_CL1SOAP_CamachoSanchezCesar.configuration;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema estacionamientoSchema) {
